...
export const BentoGridItem = ({
    ...
    const leftLists = ["ReactJS", "NodeJS", "ElectronJS"];
    const rightLists = ["NextJS", "ThreeJS", "Typescript"];

    const [copied, setCopied] = useState(false);

    const handleCopy = () => {
        const text = "hardikg.dev@gmail.com";
        ...
        >
            ...
            <div className={`${id === 6 && "flex justify-center"} h-full`}>
                ...
                <div
                    className={cn(
                        titleClassName,
                        "group-hover/bento:translate-x-2 transition duration-200 relative md:h-full min-h-64 flex flex-col px-5 p-5 lg:p-10"
                    )}
                >
                    ...
                    {id === 6 && (
                        <div className="mt-5 relative">
                            ...
                            {copied && <div className={`absolute -bottom-5 right-0 block`}>
                                <Lottie options={{
                                    loop: copied,
                                    autoplay: copied,
